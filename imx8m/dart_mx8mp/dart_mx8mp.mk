...
# NXP IW612 Wifi and Bluetooth Firmware
# The firmware name is defined in var_wifi_mod_para.conf.
# When using WiFi and BT firmware separately, set the firmware name to sd_w61x_v1.bin.se
# for WiFi, then the BT firmware will be loaded by the btnxpuart driver.
PRODUCT_COPY_FILES += \
    ...
    device/variscite/imx8m/dart_mx8mp/var_wifi_mod_para.conf:vendor/firmware/var_wifi_mod_para.conf
...
#nxp IW612 Bluetooth vendor config
PRODUCT_PACKAGES += \
    bt_vendor.conf
